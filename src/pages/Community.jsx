...
const Community = () => {
  ...
  return(<div className="p-6 pt-12 xl:px-12 2xl:px-20 w-full ma-auto h-full overflow-y-scroll">
      ...
      <div className="flex flex-wrap max-sm:justify-center gap-5">
        {images.map((item, index) => (
          ...
          >
            ...
            />
            <p className="absolute bottom-0 right-0 text-xs bg-black/50 backdrop=blur text-white px-4 py-1 rounded-tl-xl opacity-0 group-hover:opacity-100 trandition duration-300">
